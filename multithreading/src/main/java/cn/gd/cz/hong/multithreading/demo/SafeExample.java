...
public class SafeExample {
    ...
    *///:~
    ...
    public static void assemblyTeam() {
        List<String> team = Collections.synchronizedList(new ArrayList<>());
